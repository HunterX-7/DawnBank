    ...
    <section className={`${styles.flexCenter} sm:py-10 py-6 flex-col`}>
      <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full`}>
        <div className='flex-1 flex flex-col justify-start mr-10'>
          <img src={logo} alt="dawnbank" className='w-[266px] h-[72px] object-contain' />
        <p className={`${styles.paragraph} mt-4 max-w-[310px]`}>
          Seamless Payments Redefined: Simplifying Transactions, Accelerating Progress, Future-Ready Solution.
        </p>
        </div>
      ...
      <div className='w-full flex justify-between items-center md:flex-row flex-col pt-6 border-t-[1px] border-t-[grey]'>
        <p className='font-poppins font-normal text-center text-[18px] leading-[27px] text-white'>
          Copyright &copy; {currentYear} DawnBank. All Rights Reserved.
        </p>
